            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 overflow-hidden relative group">
              ...
              {appliedCoupon ? (
                <div className="bg-green-50 border border-green-100 rounded-xl p-3 flex justify-between items-center">
                  ...
                  <button onClick={() => { setAppliedCoupon(null); setCouponCode(""); }} className="text-red-500 hover:bg-red-100 p-1 rounded">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-gray-50 border-0 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-blue-600 transition-all"
                  />
                  <button
                    onClick={handleApplyCoupon}
                    className="bg-blue-600 text-white px-5 py-2 rounded-xl text-sm font-bold hover:bg-blue-700 transition-colors shadow-md shadow-blue-100"
                  >
                    Apply
                  </button>
                </div>
